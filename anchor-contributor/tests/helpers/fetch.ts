...
export async function getCustodianState(program: Program<AnchorContributor>, contributorAccount: KeyBump) {
  return program.account.custodian.fetch(contributorAccount.key);
}
