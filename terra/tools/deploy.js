...
// TODO: move out into separate script if we are removing from the mono repo
const conductorAddress =
  "0000000000000000000000005f8e26facc23fa4cbd87b8d9dbbd33d5047abde1";

addresses["icco_contributor.wasm"] = await instantiate(
  "icco_contributor.wasm",
  {
    gov_chain: govChain,
    gov_address: Buffer.from(govAddress, "hex").toString("base64"),
    wormhole_contract: addresses["wormhole.wasm"],
    token_bridge_contract: addresses["token_bridge.wasm"],
    conductor_chain: 2,
    conductor_address: Buffer.from(conductorAddress, "hex").toString("base64"),
  }
);
